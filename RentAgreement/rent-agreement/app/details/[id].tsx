...
//   const BASE_URL = "http://192.168.1.108:8000"; // <--- Apna IP check karein
...
//   if (!data) return <View style={styles.container}><Text>No data found</Text></View>;
...
//         <Text style={styles.title}>Agreement Details #{id}</Text>
...
//         <Text style={styles.info}>Duration: {data.details.start_date} to {data.details.end_date}</Text>
//       </View>
...
//     if (!next) {
//       Alert.alert('Info', 'Agreement already completed');
//       return;
//     }
...
//       if (!res.ok) {
//         Alert.alert('Error', json.detail || 'Status update failed');
//       } else {
